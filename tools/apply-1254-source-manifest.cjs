...
if(!fs.existsSync(manifestPath)){console.error("Missing src/manifest.json. Run this from the repository root after overlaying Browser 1254.");process.exit(1);}
...
manifest.status="tactical-horizon-fog-integrated-solid-depth-fade-hotfix-complete";
manifest.gameplayParity={...manifest.gameplayParity,browserBuild:build};
fs.writeFileSync(manifestPath,JSON.stringify(manifest,null,2)+"\n");
console.log("Updated src/manifest.json to Browser 1254 without replacing unrelated content.");
