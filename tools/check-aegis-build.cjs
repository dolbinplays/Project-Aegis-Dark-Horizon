...
const required = [
  ...
  "Unengaged soldiers keep immediate VIP contact priority despite remote squad contacts",
  ...
  "Three.js tactical framing preserves the complete lower battlefield edge",
