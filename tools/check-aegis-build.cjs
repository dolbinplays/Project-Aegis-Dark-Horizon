...
const required = [
  ...
  "MOBILE_LANDSCAPE_INTERFACE_PATCH",
  "GEOSCAPE_MOBILE_BROWSER_POINTER_CAPTURE_LIFECYCLE_HOTFIX",
  ...
  "tacticalFireTeamBeaconAssaultState",
  "tacticalFirstClassFireTeamBeaconAssaultContractChecks",
  "Explicit Beacon assignments become typed assault orders rather than generic waypoints",
  "TACTICAL_FPV_TPV_ALIEN_CIRCULAR_CROSSHAIR_TARGET_MARKERS_PATCH",
  "tacticalPerspectiveTargetMarkerPresentation",
  "tacticalThreePersistentBuildPerspectiveTargetMarker",
  "FPV and TPV living-alien targets use a compact red circular crosshair above the alien model",
  "FPV and TPV Field Beacons retain the established ground-objective ring instead of an alien crosshair",
  "Field Beacon target circles require confirmed reinforcement-source threat knowledge",
  "TACTICAL_SMOOTH_ARTICULATED_HEX_TO_HEX_LOCOMOTION_PATCH",
  "TACTICAL_ARTICULATED_SEGMENT_FACING_AND_FORWARD_WALK_PATCH",
  "tacticalArticulatedHexTravelYaw",
  "Walking facing derives from each traversed world-space segment instead of stale tactical or camera facing",
  "Segment turns lead translation and authoritative destination facing is restored after arrival",
  "TACTICAL_ALIEN_VIP_INFORMATION_SEARCH_AND_SHARED_MEMORY_PATCH",
  "tacticalAlienVipKnowledgeFor",
  "tacticalAlienVipSearchTarget",
  "An entirely undetected VIP never becomes an exact alien target",
  "Lost contact investigates the recorded cell instead of the VIP's hidden live cell",
  "Eligible nearby aliens share confirmed sightings through explicit communication range",
  "Authored scenario prior knowledge is captured once and does not become live hidden tracking",
  "TACTICAL_LAST_KNOWN_ALIEN_CONTACT_AND_THREAT_MUSIC_PATCH",
  "tacticalLastKnownAlienContactMarkers",
  ...
  "FPV and TPV camera targets follow the interpolated presentation root",
  ...
  "TACTICAL_ARTICULATED_CIVILIAN_VIP_APPEARANCE_FEAR_AND_MOVEMENT_PATCH",
  "tacticalArticulatedCivilianPresentationState",
  "tacticalThreePersistentAddArticulatedCivilianModel",
  "tacticalArticulatedCivilianVipContractChecks",
  "Civilian clothing and body variation are deterministic while VIPs use dark suits with bounded shirt and tie variation",
  "Civilian movement reuses the soldier leg gait while preserving calm or fear upper-body poses",
  "TACTICAL_OBJECTIVE_ASSIGNMENT_TRANSACTIONAL_CANCEL_PATCH",
  "tacticalCancelFireTeamObjectiveAssignmentDraft",
  "tacticalObjectiveAssignmentTransactionalCancelContractChecks",
  "Cancel discards every objective draft change while preserving direct default and assist assignments exactly",
  "Repeated objective-assignment cancellation is idempotent and cannot invoke apply or AI replanning",
  "ORANGE_LASER_CARBINE_EQUIPMENT_IDENTITY_PATCH",
  "EQUIPMENT_IDENTITY_PRESENTATIONS",
  "orangeLaserCarbineEquipmentIdentityContractChecks",
  "Laser Carbine has one canonical orange UI, model, and shot presentation",
  "Orange Laser Carbine identity is presentation-only and leaves save format unchanged",
  "SELECTED_SQUAD_MORALE_SUMMARY_MISSION_CONTROL_PATCH",
  "selectedSquadMissionMoraleSummary",
  "SelectedSquadMoraleSummaryPanel",
  "Selected squad morale reports exact highest lowest and arithmetic average readiness",
  "Mission Control renders the live selected-squad morale panel without changing save authority",
  ...
  "Standing Aim uses its corrected local firing orientation without changing tactical facing",
  ...
  "TACTICAL_ARTICULATED_AIM_AND_WALK_DIRECTION_CORRECTION_PATCH",
  "TACTICAL_RANGE_SCALED_ACCURACY_PATCH",
  "tacticalRangeAccuracyModifier",
  "tacticalRangeAdjustedHitChance",
  "tacticalAimWalkDirectionAndRangeAccuracyContractTest",
  "Standing Aim faces its target, walking feet cycle forward, and all tactical shots share bounded range accuracy",
  ...
  "function tacticalSameAlienDropship(",
  "left.crashedUfo||right.crashedUfo",
  ...
  "aegisIsoColor",
  "Player-adjustable 3D Color persists across screens and applies to Iso and perspective canvas presentation",
  ...
  "Shared 3D Night Brightness lifts renderer exposure and ambient shadows without changing tactical illumination",
...
for (const immutableBuild of [
  ...
  "v0.26.09.07.2059_MOBILE_OBJECTIVE_ASSIGNMENT_MODAL_LAYERING_HOTFIX",
  "v0.26.09.07.2141_MOBILE_COMMAND_WINDOWS_AND_PLACEMENT_COHABITATION_PATCH",
  "v0.26.09.07.2258_MOBILE_QUARTERMASTER_INVENTORY_ADAPTIVE_LAYOUT_PATCH"
]) {
