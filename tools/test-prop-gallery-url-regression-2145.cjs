...
assert.ok(js.includes("v0.26.09.17.2145_ORIGINAL_PROP_MODEL_RESTORATION_AND_FACTORY_BACKUP_PATCH"));
...
console.log('AEGIS installed-app gallery URL regression tests passed under 2145.');
