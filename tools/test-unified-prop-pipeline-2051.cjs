...
check(sw.includes('aegis-v0.26.09.18.2051_IN_GAME_TOOLS_AND_PROP_EDITOR_ACCESS_PATCH'),'service worker cache was not bumped');
...
check(meta.build==='v0.26.09.18.2051_IN_GAME_TOOLS_AND_PROP_EDITOR_ACCESS_PATCH','release metadata build mismatch');
check(meta.save_format===4,'release metadata save format changed');
check(meta.runtime_extension_build===meta.build,'release metadata runtime extension mismatch');
