const AEGIS_PWA_CACHE = "aegis-v0.26.09.07.1404_MOBILE_BASE_COMMAND_ADAPTIVE_LAYOUT_PATCH";
const AEGIS_RUNTIME_CACHE = "aegis-runtime-v0.26.09.07.1404_MOBILE_BASE_COMMAND_ADAPTIVE_LAYOUT_PATCH";
const AEGIS_SHELL = [
  "./index.html",
