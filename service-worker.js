const AEGIS_PWA_CACHE = "aegis-v0.26.09.07.2059_MOBILE_OBJECTIVE_ASSIGNMENT_MODAL_LAYERING_HOTFIX";
const AEGIS_RUNTIME_CACHE = "aegis-runtime-v0.26.09.07.2059_MOBILE_OBJECTIVE_ASSIGNMENT_MODAL_LAYERING_HOTFIX";
const AEGIS_SHELL = [
  "./index.html",
