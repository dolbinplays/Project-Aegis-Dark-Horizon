const AEGIS_PWA_CACHE = "aegis-v0.26.09.09.2154_CLASSIC_LINEUP_VIP_RESCUE_PRIORITY_AND_SUPPORT_STANDOFF_PATCH";
const AEGIS_RUNTIME_CACHE = "aegis-runtime-v0.26.09.09.2154_CLASSIC_LINEUP_VIP_RESCUE_PRIORITY_AND_SUPPORT_STANDOFF_PATCH";
const AEGIS_SHELL = [
  "./index.html",
