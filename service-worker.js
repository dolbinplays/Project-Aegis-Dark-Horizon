const AEGIS_PWA_CACHE = "aegis-v0.26.09.11.1448_PROCEDURAL_BUILDING_FACADE_CONNECTOR_INFILL_HOTFIX";
const AEGIS_RUNTIME_CACHE = "aegis-runtime-v0.26.09.11.1448_PROCEDURAL_BUILDING_FACADE_CONNECTOR_INFILL_HOTFIX";
const AEGIS_SHELL = [
  "./index.html",
