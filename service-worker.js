const AEGIS_PWA_CACHE = "aegis-v0.26.09.10.1735_CLASSIC_LINEUP_PATCH_HISTORY_INITIALIZATION_HOTFIX";
const AEGIS_RUNTIME_CACHE = "aegis-runtime-v0.26.09.10.1735_CLASSIC_LINEUP_PATCH_HISTORY_INITIALIZATION_HOTFIX";
const AEGIS_SHELL = [
  "./index.html",
