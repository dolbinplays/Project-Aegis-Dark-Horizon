const AEGIS_PWA_CACHE = "aegis-v0.26.09.11.1740_MOBILE_TACTICAL_STATUS_HUD_COLLAPSE_EXPAND_PATCH";
const AEGIS_RUNTIME_CACHE = "aegis-runtime-v0.26.09.11.1740_MOBILE_TACTICAL_STATUS_HUD_COLLAPSE_EXPAND_PATCH";
const AEGIS_SHELL = [
  "./index.html",
