const AEGIS_PWA_CACHE = "aegis-v0.26.09.07.1231_MOBILE_GEOSCAPE_ADAPTIVE_PHONE_TABLET_LAYOUT_PATCH";
const AEGIS_RUNTIME_CACHE = "aegis-runtime-v0.26.09.07.1231_MOBILE_GEOSCAPE_ADAPTIVE_PHONE_TABLET_LAYOUT_PATCH";
const AEGIS_SHELL = [
  "./index.html",
